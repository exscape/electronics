...
class I2C16
{
  public:
	...
	uint8_t write(uint8_t address, uint16_t registerAddress);
	uint8_t write(int address, int registerAddress);
	uint8_t write(uint8_t address, uint16_t registerAddress, uint8_t data);
	uint8_t write(int address, int registerAddress, int data);
	uint8_t write(uint8_t address, uint16_t registerAddress, char *data);
	uint8_t write(uint8_t address, uint16_t registerAddress, uint8_t *data, uint8_t numberBytes);
	...
	uint8_t read(uint8_t address, uint16_t registerAddress, uint8_t numberBytes);
	...
	uint8_t acknowledgePoll(uint8_t i2cAddress);
