...
uint8_t I2C16::bytesAvailable = 0;
uint8_t I2C16::bufferIndex = 0;
uint8_t I2C16::totalBytes = 0;
uint16_t I2C16::timeOutDelay = 0;
...
void I2C16::timeOut(uint16_t _timeOut)
{
  timeOutDelay = _timeOut;
}

void I2C16::setSpeed(uint8_t _fast)
{
  if(!_fast)
  {
    TWBR = ((F_CPU / 100000) - 16) / 2;
...
void I2C16::pullup(uint8_t activate)
{
  if(activate)
  {
    #if defined(__AVR_ATmega168__) || defined(__AVR_ATmega8__) || defined(__AVR_ATmega328P__)
...
uint8_t I2C16::available()
{
  return(bytesAvailable);
}

uint8_t I2C16::receive()
{
...
uint8_t I2C16::write(uint8_t address, uint16_t registerAddress)
{
  returnStatus = 0;
  returnStatus = start();
...
uint8_t I2C16::write(int address, int registerAddress)
{
  return(write((uint8_t) address, (uint16_t) registerAddress));
}

uint8_t I2C16::write(uint8_t address, uint16_t registerAddress, uint8_t data)
{
  returnStatus = 0;
  returnStatus = start(); 
  if(returnStatus){return(returnStatus);}
...
uint8_t I2C16::write(int address, int registerAddress, int data)
{
  return(write((uint8_t) address, (uint16_t) registerAddress, (uint8_t) data));
}

uint8_t I2C16::write(uint8_t address, uint16_t registerAddress, char *data)
{
...
uint8_t I2C16::write(uint8_t address, uint16_t registerAddress, uint8_t *data, uint8_t numberBytes)
{
  returnStatus = 0;
  returnStatus = start();
  if(returnStatus){return(returnStatus);}
...
uint8_t I2C16::read(int address, int numberBytes)
{
  return(read((uint8_t) address, (uint8_t) numberBytes));
}

uint8_t I2C16::read(uint8_t address, uint8_t numberBytes)
{
  bytesAvailable = 0;
  bufferIndex = 0;
...
uint8_t I2C16::read(int address, int registerAddress, int numberBytes)
{
  return(read((uint8_t) address, (uint16_t) registerAddress, (uint8_t) numberBytes));
}

uint8_t I2C16::read(uint8_t address, uint16_t registerAddress, uint8_t numberBytes)
{
  bytesAvailable = 0;
  bufferIndex = 0;
  if(numberBytes == 0){numberBytes++;}
...
uint8_t I2C16::read(uint8_t address, uint8_t numberBytes, uint8_t *dataBuffer)
{
  bytesAvailable = 0;
  bufferIndex = 0;
  if(numberBytes == 0){numberBytes++;}
...
uint8_t I2C16::read(uint8_t address, uint16_t registerAddress, uint8_t numberBytes, uint8_t *dataBuffer)
{
  bytesAvailable = 0;
  bufferIndex = 0;
  if(numberBytes == 0){numberBytes++;}
...
uint8_t I2C16::sendAddress(uint8_t i2cAddress)
{
  TWDR = i2cAddress;
  unsigned long startingTime = millis();
  TWCR = (1<<TWINT) | (1<<TWEN);
...
uint8_t I2C16::acknowledgePoll(uint8_t i2cAddress)
{
...
uint8_t I2C16::sendByte(uint8_t i2cData)
{
  TWDR = i2cData;
  unsigned long startingTime = millis();
  TWCR = (1<<TWINT) | (1<<TWEN);
...
uint8_t I2C16::receiveByte(uint8_t ack)
{
  unsigned long startingTime = millis();
  if(ack)
  {
